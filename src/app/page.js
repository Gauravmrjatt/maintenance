...
export default function Home() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center min-h-screen text-foreground p-6">
      {/* Left Side - Image */}
      <div className="mb-8 md:mb-0 md:mr-10">
        <Image src="/man.svg" alt="Maintenance illustration" height={500} width={500} />
      </div>

      {/* Right Side - Content */}
      <div className="text-center md:text-left space-y-6 max-w-xl">
        <h1 className="text-5xl font-bold text-yellow-400">Under Maintenance</h1>

        <p className="text-lg text-gray-300">
          We’re currently working on some updates to improve your experience. <br />
          Please check back later.
        </p>

        <div className="flex items-center justify-center md:justify-start space-x-3 animate-pulse">
          ...
          <Link
            href="https://telegram.dog/Earning_Area11" // <-- Replace with your real Telegram link
